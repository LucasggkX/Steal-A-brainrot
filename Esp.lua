...
local descAddedConn = workspace.DescendantAdded:Connect(function(inst)
    if _G.God and godsSet[inst.Name] then
        createESP(inst, "god", Color3.fromRGB(255,0,0), inst.Name)
    end
    if _G.Secret and secretsSet[inst.Name] then
...
secretButton.MouseButton1Click:Connect(function()
    ...
    if _G.Secret then scanNamesFor(secretsSet,"secret",Color3.fromRGB(0,128,255)) else removeCategory("secret") end
end)

godButton.MouseButton1Click:Connect(function()
    _G.God = not _G.God
    setBtnState(godButton,_G.God)
    if _G.God then scanNamesFor(godsSet,"god",Color3.fromRGB(255,0,0)) else removeCategory("god") end
end)
